    ...
    class ProgramaPrincipal
    {
        ...
        public static int Main(string[] args)
        {
            ...
            for (int i = 0; i <= args.Length - 1; i++)
            {
                ...
                else if (String.Compare(argumento, "-N") == 0)
                {
                    if (args.Length < (i + 2))
                    {
                        Console.WriteLine("Error: no se especificó el Comprobante Numero (long)");
                        return -1;
                    }
                    else
                    {
                        cbteNro = long.Parse(args[i + 1]);
                        i = i + 1;
                    }
                }
            ...
            if(isMissingParameter(longCuit, cbteTipo, cbteNro, ptoVta))
            {
                return -3;
            }
            ...
            try
            {
                if (blnVerboseMode)
                {
                    ...
                    Console.WriteLine("***Comprobante Nro: {0}", cbteNro);
        ...
        public static bool isMissingParameter(long longCuit, int cbteTipo, long cbteNro, int ptoVta)
        {
            ...
            if (cbteNro == DEFAULT_CBTENRO)
            {
                Console.WriteLine("Debe especificar un Comprobante Nro");
                explicarUso();
                return true;
            }
        ...
        public static void explicarUso()
        {
            ...
            Console.WriteLine(" -N CbteNro");
            Console.WriteLine(" Obligatorio, sin default (long)");
